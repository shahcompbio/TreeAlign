...
def main():
    ...
    cnv, expr, per_copy_expr, psi, w = get_parameters(expr, cnv)
    ...
    for gene_type_freq in gene_type_freqs:
        ...
        expr_simulated_dataframe.to_csv("simulation/expr_simulated_" + str(gene_type_freq) + ".csv")
        gene_type_score_simuated_dataframe.to_csv("simulation/gene_type_score_simulated_" + str(gene_type_freq) + ".csv")
        clone_assign_simulated_dataframe.to_csv("simulation/clone_assign_simulated_" + str(gene_type_freq) + ".csv")
