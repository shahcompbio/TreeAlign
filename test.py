...
expr = pd.read_csv("/Users/shih/pyro_tutorial/clonealign_pyro/data/SPECTRUM-OV-045_expr.csv", index_col=0)
cnv = pd.read_csv("/Users/shih/pyro_tutorial/clonealign_pyro/data/SPECTRUM-OV-045_gene_cnv.csv", index_col=0)
clone = pd.read_csv("/Users/shih/pyro_tutorial/clonealign_pyro/data/SPECTRUM-OV-045_cnv_meta.csv")

tree = Phylo.read("/Users/shih/pyro_tutorial/clonealign_pyro/data/SPECTRUM-OV-045_tree.newick", "newick")
